				...
				<div class="left_container">
					...
					<table class="form_table">
						...
						<tr>
							<td>GM Users</td>
							<td>
								<select required name="gm_user" class="txtBx">
									<?php
									$result = mysql_query("select * from admin_login where userType = '8' AND status !='0' ORDER BY name");
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" id="exportType" value="GMReport" name="exportType" />
							</td>
						</tr>
					</table>
					</form>
