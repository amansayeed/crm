...
if($_SESSION['userType'] == 6 || $_SESSION['userType'] == 7 || $_SESSION['userType'] == 14) {
	...
	$whereCase1 = " AND (userId IN (select userId from admin_login where superior1 IN (select userId from admin_login where superior1 = '".$_SESSION['userId']."')) OR assignedTo = '".$_SESSION['userId']."' OR userId = '".$_SESSION['userId']."' OR userId IN (select userId from admin_login where superior1 = '".$_SESSION['userId']."'))";
}
