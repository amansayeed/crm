...
<div class="right_container">
	<ul class="main_nav">
		<?php
		if($_SESSION['userType'] == 1 || $_SESSION['userType'] == 10 || $_SESSION['userType'] == 2 || $_SESSION['userType'] == 5 || $_SESSION['userType'] == 6 || $_SESSION['userType'] == 7 || $_SESSION['userType'] == 14 || $_SESSION['userType'] == 8) { ?>
			<li>
				...
				<ul class="module_list disp_none" id="module_list_lead">
					...
					<?php } ?>
					<?php if($_SESSION['userType'] != 3 && $_SESSION['userType'] != 4 && $_SESSION['userType'] != 6 && $_SESSION['userType'] != 14 && $_SESSION['userType'] != 7 && $_SESSION['userType'] != 9) { ?>
						<li>
							<img src="images/icon_data.png" />
		...
		<?php } if($_SESSION['userType'] == 1 || $_SESSION['userType'] == 8 || $_SESSION['userType'] == 10 || $_SESSION['userType'] == 11 || $_SESSION['userType'] == 12 || $_SESSION['userType'] == 13) { ?>
			<li>
				...
				<ul class="module_list disp_none" id="module_list_pro">
					<li>
						<img src="images/icon_dash.png" />
						<a href="project/dashboard.php?clear=1"> Dashboard</a>
					</li>
					<?php if($_SESSION['userType'] == 1 || $_SESSION['userType'] == 8 || $_SESSION['userType'] == 10 || $_SESSION['userType'] == 11 || $_SESSION['userType'] == 12 || $_SESSION['userType'] == 13) { ?>
					<li>
						<img src="images/icon_data.png" />
						...
						<?php if($_SESSION['userType'] != 13) { ?>
								<li>
									<img src="images/icon_arrow.png" />
									<a href="project/manage_data.php?list=1&listType=1&clear=1"> Unassigned  (<?php echo mysql_num_rows($pro_pendQuery); ?>)</a>
								</li>
							<?php } ?>
							<li>
								<img src="images/icon_arrow.png" />
								<a href="project/manage_data.php?list=2&listType=1&clear=1"> Assigned (<?php echo mysql_num_rows($pro_assQuery); ?>)</a>
							</li>
							<li>
								<img src="images/icon_arrow.png" />
								<a href="project/manage_data.php?list=5&listType=1&clear=1"> Approval (<?php echo mysql_num_rows($pro_approvalQuery); ?>)</a>
							</li>
							<li>
								<img src="images/icon_arrow.png" />
								<a href="project/manage_data.php?list=3&listType=1&clear=1"> Completed (<?php echo mysql_num_rows($pro_comQuery); ?>)</a>
							</li>
							<li>
								<img src="images/icon_arrow.png" />
								<a href="project/manage_data.php?list=8&listType=1&clear=1"> Partially Completed (<?php echo mysql_num_rows($pro_parComQuery); ?>)</a>
							</li>
							<?php if($_SESSION['userType'] == 11 || $_SESSION['userType'] == 1 || $_SESSION['userType'] == 8 || $_SESSION['userType'] == 10) { ?>
								<li>
									<img src="images/icon_arrow.png" />
									<a href="project/manage_data.php?list=4&listType=1&clear=1"> Closed (<?php echo mysql_num_rows($pro_closeQuery); ?>)</a>
								</li>
							<?php } ?>
							<?php if($_SESSION['userType'] == 12 || $_SESSION['userType'] == 13 || $_SESSION['userType'] == 1 || $_SESSION['userType'] == 8 || $_SESSION['userType'] == 10) { ?>
								<li>
									<img src="images/icon_arrow.png" />
									<a href="project/manage_data.php?list=6&listType=1&clear=1"> Reassigned (<?php echo mysql_num_rows($pro_reassignQuery); ?>)</a>
								</li>
							<?php } ?>
							<?php if($_SESSION['userType'] == 12 || $_SESSION['userType'] == 13 || $_SESSION['userType'] == 1 || $_SESSION['userType'] == 8 || $_SESSION['userType'] == 10) { ?>
								<li>
									<img src="images/icon_arrow.png" />
									<a href="project/manage_data.php?list=7&listType=1&clear=1"> Rejected (<?php echo mysql_num_rows($pro_rejectedQuery); ?>)</a>
								</li>
							<?php } ?>
						</ul>
					</li>
