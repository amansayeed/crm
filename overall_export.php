				...
				<div class="left_container">
					...
					<table class="form_table">
						<tr>
							<td>Export Type</td>
							<td>
								<select required name="report_By" class="txtBx">
									<option value="1">Lead Data</option>
						...
						<tr>
							<td></td>
							<td><input type="submit" class="subBtn frm_sub" name="data_export" value="Export"/></td>
						</tr>
					</table>
					</form>
				</div>
